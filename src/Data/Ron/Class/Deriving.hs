...
--          via RonWith '[FieldsDropPrefix, DecodeWith SkipSingleConstructor] MyType
-- @
--
...
-- letters, regex @s/^_[[:lowercase:]]+([[:uppercase:]].*)/\1/@. You probably
-- want to use this field modifier before other field modifiers, as they are
